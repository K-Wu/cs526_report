...
\begin{itemize}
  ...
  \item Commutative binary operators: Reordering possibly enables vectorization. 
\end{itemize}
...
\begin{frame}{}
\begin{block}{Prune the Vectorization Tree for More Profit.}
  \begin{itemize}
    \item We adopt this idea from TSLP\textsuperscript{[5]}.
...
\begin{itemize}
\item Our pass is compared with the original SLP vectorizer from in 8.0.1.
